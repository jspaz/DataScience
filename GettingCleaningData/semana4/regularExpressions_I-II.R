...
# () las subexpresiones contenidas en parÃ©ntesisis contienen las alternativas: ^([Gg]ood|[Bb]ad)
...
# {and} permite especificar el número máximo y máximo de las expresiones coincidentes: [Bb]ush( +[^ ]+ +){1,5} debate
# m,n significa por lo menos m pero no mÃ¡s de n coincidencias: 
...
# * tambiÃ©n permite buscar la coincidencia de caracteres mÃ¡s larga que satisfaga la expresiÃ³n: ^S(.*)s
